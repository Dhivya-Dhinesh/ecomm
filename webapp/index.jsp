...
<h1>
<img src="C:\NIIT\UI PAGES\logo.png" >
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand">BooksCorner</a>
    </div>
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="productdisplay">productdisplay</a></li>
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <span class="glyphicon glyphicon-user"></span>Sign up</a>
        <ul class="dropdown-menu">
          ...
          <li><a href="contactus"><span class="glyphicon glyphicon-log-in"></span> Support</a></li>
...
<a href=#></a><span class="glyphicon glyphicon-phone-alt"></span>
 <a href="aboutus">ABOUT US</a>

  <p class="w3-medium">
    Powered by <a href="aboutus" target="_blank">BooksCorner</a>
  </p>
</footer>
